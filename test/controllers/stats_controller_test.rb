...
class StatsControllerTest < ActionController::TestCase
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post :create, stat: { average: @stat.average, maximum: @stat.maximum, minimum: @stat.minimum, timestamp: @stat.timestamp }
    end
  ...
  test "should update stat" do
    patch :update, id: @stat, stat: { average: @stat.average, maximum: @stat.maximum, minimum: @stat.minimum, timestamp: @stat.timestamp }
    assert_redirected_to stat_path(assigns(:stat))
  end
